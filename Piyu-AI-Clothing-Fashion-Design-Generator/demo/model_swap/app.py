...
TRYON_SERVER_HOST = "https://prod.server.piyu.ai"
        ...
        def rerender1(user_token1):
            with gr.Column(elem_id="login-modal"):
                access_token = gr.Textbox(
                    ...
                    info="Visit https://playground.piyu.ai to retrieve your access token."
                )
        ...
        def rerender(is_logged_in):
            with gr.Column():
                if not is_logged_in:
                    ...
                    <p style="text-align: right;">Visit <a href="https://playground.piyu.ai">
