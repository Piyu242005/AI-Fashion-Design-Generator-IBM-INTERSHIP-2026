...
Calls the FastAPI auth endpoints and updates session state on success.
"""
...
def render_login_form() -> None:
    ...
    st.markdown(
        ...
        <div style="text-align:center;margin-bottom:32px;">
            ...
            <h1 style="font-size:26px;color:#e2e8f0;margin:0;">Welcome Back</h1>
...
def render_register_form() -> None:
    ...
    st.markdown(
        ...
        <div style="text-align:center;margin-bottom:32px;">
            <div style="font-size:48px;margin-bottom:8px;">✨</div>
            <h1 style="font-size:26px;color:#e2e8f0;margin:0;">Create Account</h1>
            <p style="color:#64748b;font-size:14px;margin-top:6px;">
